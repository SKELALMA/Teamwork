	      ...
	      <div class="collapse navbar-collapse justify-content-md-center" id="navbarsExample10">        
	        <a class="navbar-brand" href="./main.html">
	          <a class="nav-link active" aria-current="page" href="http://localhost:8080/myhome/">
	          	<img src="./resources/images/MainPage_logo.png/" alt="Logo" 
...
<!-- --------------------------- NAV ------------------------------------- -->
    <nav class="navbar navbar-expand-md bg-success navbar-dark" id="menu">
    ...
    <div class="container">
      <a class="navbar-brand" href="./main.html">
        <a class="nav-link active" aria-current="page" href="http://localhost:8080/myhome/"><img src="./resources/images/MainPage_logo.png/" alt="Logo" style="height: 60px; width: 100%;" >
 	  	</a>
      </a>
