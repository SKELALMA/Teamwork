...
<div class="container" style="margin-top:80px">
  ...
  <div class="input-group mb-3">
    <input type="text" class="form-control" placeholder="도로주소" name="user_address1" id="user_address1"
    value="<%=dto.getUser_address1()%>">
  </div>

  <div class="input-group mb-3">
    <input type="text" class="form-control" placeholder="상세주소" name="user_address2" id="user_address2"
