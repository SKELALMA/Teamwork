...
<%@page import="com.woori.myhome.admin.ReceipeBoard.*" %>
...
<%
	...
	List<AdminReceipeBoardDto> list = (List<AdminReceipeBoardDto>)request.getAttribute("receipeList");
%> 
...
function goSearch(){
	...
	frm.pg.value=0;
	frm.action = "<%=request.getContextPath()%>/receipe/list";
	frm.method="get";
	frm.submit();
}
...
function goPage(pg)
{
	...
	frm.pg.value=pg;///////////
	frm.method="get";
	frm.action="${pageContext.request.contextPath}/receipe/list";
	frm.submit();
}
