...
<body>
	...
	<%
	ReceipeBoardDto dto = (ReceipeBoardDto)request.getAttribute("receipeDto");
	%>
        ...
        <table class="table table-hover " style="margin-top: 30px;">
            ...
            <tbody>
              <tr>
                ...
                <td>
                    <div class="mb-3" style="margin-top:13px;">
                        ...
                        placeholder="요리를 입력하세요" value="<%=dto.getTitle()%>">
                    </div>
                </td>
              </tr>       
              <tr>
              ...
              <tr>
                ...
                <td>
                    <div >
       					<textarea class="form-control" rows="5" id="editor" name="comment" 
       					placeholder="레시피를 작성해주세요"><%=dto.getComment()%></textarea> 
    				</div>
                </td>
              </tr> 
...
.create( document.querySelector( '#editor' ), 
		 {
		ckfinder: {
	        uploadUrl: '/myhome/ck/fileupload3' // 내가 지정한 업로드 url (post로 요청감)
		},
		alignment: {
...
function goWrite()
{
	...
	frm.action="<%=request.getContextPath()%>/receipe/save";
	frm.method="post";
	frm.submit(); //서버로 전송하기 
