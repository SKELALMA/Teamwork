...
//		dto.setTitle("Re:" + dto.getTitle());
	...
	// ***********************comment***************************
	@RequestMapping(value="/qnaboard/comment/write")
	@ResponseBody
...
//		service.comment_insert(dto);
	...
	@RequestMapping(value="/qnaboard/comment/list")
	@ResponseBody
	...
	@RequestMapping(value="/qnaboard/comment/getView")
	@ResponseBody
	...
	@RequestMapping(value="/qnaboard/comment/update")
	@ResponseBody
	...
	@RequestMapping(value="/qnaboard/comment/delete")
	@ResponseBody
